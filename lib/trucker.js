...
export default {
  ...
  move() {
    console.log('Trucker was toggled!', getPathOfActiveFile(), getPathOfActiveFile() + '-moved');

    const command = TRUCKER_PATH
    const args = ['--scope', getProjectWorkingDirectory(), '--dry-run', getPathOfActiveFile(), getPathOfActiveFile() + '-moved']
